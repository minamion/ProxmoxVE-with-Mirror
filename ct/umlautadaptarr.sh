#!/usr/bin/env bash
source <(curl -fsSL https://proxy.seaslug.moe/raw.githubusercontent.com/minamion/ProxmoxVE-with-Mirror/refs/heads/main/misc/build.func)
...
function update_script() {
    ...
    RELEASE=$(curl -fsSL https://proxy.seaslug.moe/api.github.com/repos/PCJones/Umlautadaptarr/releases/latest | grep "tag_name" | awk '{print substr($2, 2, length($2)-3)}')
