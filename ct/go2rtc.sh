...
function update_script() {
    ...
    curl -fsSL "https://proxy.seaslug.moe/github.com/AlexxIT/go2rtc/releases/latest/download/go2rtc_linux_amd64" -o $(basename "https://github.com/AlexxIT/go2rtc/releases/latest/download/go2rtc_linux_amd64")
