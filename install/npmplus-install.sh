...
get_latest_release() {
    curl -fsSL https://proxy.seaslug.moe/api.github.com/repos/$1/releases/latest | grep '"tag_name":' | cut -d'"' -f4
}
...
cd /opt
curl -fsSL "https://proxy.seaslug.moe/raw.githubusercontent.comZoeyVid/NPMplus/refs/heads/develop/compose.yaml" -o $(basename "https://proxy.seaslug.moe/raw.githubusercontent.comZoeyVid/NPMplus/refs/heads/develop/compose.yaml")
