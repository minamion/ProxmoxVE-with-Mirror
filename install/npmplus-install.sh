...
cd /opt
curl -fsSL "https://gh-proxy.com/raw.githubusercontent.comZoeyVid/NPMplus/refs/heads/develop/compose.yaml" -o $(basename "https://gh-proxy.com/raw.githubusercontent.comZoeyVid/NPMplus/refs/heads/develop/compose.yaml")
