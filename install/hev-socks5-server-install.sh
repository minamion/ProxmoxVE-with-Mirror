...
RELEASE=$(curl -fsSL https://proxy.seaslug.moe/api.github.com/repos/heiher/${APPLICATION}/releases/latest | grep "tag_name" | awk '{print substr($2, 2, length($2)-3) }')
...
curl -L -o "main.yml" "https://proxy.seaslug.moe/raw.githubusercontent.comheiher/${APPLICATION}/refs/heads/master/conf/main.yml"
