...
mkdir -p /opt/komodo
cd /opt/komodo
curl -fsSL "https://gh-proxy.com/raw.githubusercontent.commoghtech/komodo/main/compose/$DB_COMPOSE_FILE" -o $(basename "https://gh-proxy.com/raw.githubusercontent.commoghtech/komodo/main/compose/$DB_COMPOSE_FILE")

msg_info "Setup Komodo Environment"
curl -fsSL "https://gh-proxy.com/raw.githubusercontent.commoghtech/komodo/main/compose/compose.env" -o "/opt/komodo/compose.env"
