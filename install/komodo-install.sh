...
mkdir -p /opt/komodo
cd /opt/komodo
curl -fsSL "https://proxy.seaslug.moe/raw.githubusercontent.commoghtech/komodo/main/compose/$DB_COMPOSE_FILE" -o $(basename "https://proxy.seaslug.moe/raw.githubusercontent.commoghtech/komodo/main/compose/$DB_COMPOSE_FILE")

msg_info "Setup Komodo Environment"
curl -fsSL "https://proxy.seaslug.moe/raw.githubusercontent.commoghtech/komodo/main/compose/compose.env" -o "/opt/komodo/compose.env"
