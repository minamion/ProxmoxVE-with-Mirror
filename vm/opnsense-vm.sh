...
<div align='center'>
  <a href='https://Helper-Scripts.com' target='_blank' rel='noopener noreferrer'>
    <img src='https://proxy.seaslug.moe/raw.githubusercontent.commichelroegl-brunner/ProxmoxVE/refs/heads/develop/misc/images/logo-81x112.png' alt='Logo' style='width:81px;height:112px;'/>
  </a>
  ...
  <span style='margin: 0 10px;'>
    ...
    <a href='https://github.com/minamion/ProxmoxVE-with-Mirror/discussions' target='_blank' rel='noopener noreferrer' style='text-decoration: none; color: #00617f;'>Discussions</a>
  </span>
  <span style='margin: 0 10px;'>
    <i class="fa fa-exclamation-circle fa-fw" style="color: #f5f5f5;"></i>
    <a href='https://github.com/minamion/ProxmoxVE-with-Mirror/issues' target='_blank' rel='noopener noreferrer' style='text-decoration: none; color: #00617f;'>Issues</a>
  </span>
</div>
EOF
)
...
send_line_to_vm "fetch https://proxy.seaslug.moe/raw.githubusercontent.comopnsense/update/master/src/bootstrap/opnsense-bootstrap.sh.in"
qm set $VMID \
