...
for version in "${VERSIONS[@]}"; do
  eval "$version=$(curl -fsSL https://proxy.seaslug.moe/raw.githubusercontent.comhome-assistant/version/master/stable.json | grep '"ova"' | cut -d '"' -f 4)"
done
YW=$(echo "\033[33m")
BL=$(echo "\033[36m")
HA=$(echo "\033[1;34m")
...
qm set $VMID \
  ...
  -boot order=scsi0 \
  -description "<div align='center'><a href='https://Helper-Scripts.com' target='_blank' rel='noopener noreferrer'><img src='https://proxy.seaslug.moe/raw.githubusercontent.com/minamion/ProxmoxVE-with-Mirror/main/misc/images/logo-81x112.png'/></a>
