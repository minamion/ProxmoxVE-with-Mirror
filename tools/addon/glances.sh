...
install() {
  ...
  $STD bash -c "$(curl -fsSL https://proxy.seaslug.moe/raw.githubusercontent.comnicolargo/glancesautoinstall/master/install.sh)"
...
uninstall() {
  ...
  bash -c "$(curl -fsSL https://proxy.seaslug.moe/raw.githubusercontent.comnicolargo/glancesautoinstall/master/uninstall.sh)"
