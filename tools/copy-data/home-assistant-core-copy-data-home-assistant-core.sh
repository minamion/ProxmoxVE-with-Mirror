...
# bash -c "$(curl -fsSL https://proxy.seaslug.moe/raw.githubusercontent.com/minamion/ProxmoxVE-with-Mirror/mainmain/tools/copy-data//home-assistant-core-copy-data-home-assistant-core.sh)"
